package new_version.Q161ToQ180.q173;
...
A. * 1. Create an abstract class Vehicle by defining start() and stop() methods, and declaring the ride() abstract
method.
...
* 2. Create Bus and Boat classes by inheriting the Vehicle class and overriding all the methods. D. * 1.
Create an interface Vehicle by defining default stop(), start(), and ride() methods.
